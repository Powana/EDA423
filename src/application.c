...
MusicPlayer music_player = {initObject(), DEFAULT_KEY, DEFAULT_TEMPO, .note_idx=0, .is_playing=0, .is_led_blinking=0, .cur_note_modulo=0, .nth_note_to_play=0, .current_note_segment=0};
